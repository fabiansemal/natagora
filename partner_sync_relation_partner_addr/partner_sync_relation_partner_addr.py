...
class res_partner(models.Model):
	...
	no_address = fields.Boolean("Pas d'adresse", default=False)
	street_id = fields.Many2one('res.country.city.street', ondelete='set null', string="Rue ID")
	street_nbr = fields.Char("Numéro", size=16)
	street_bus = fields.Char("Boite Rue", size=16)
	zip_id = fields.Many2one('res.country.city', ondelete='set null', string="Commune ID")
	postbus_nbr = fields.Char('Boite', len=16)
